...
for iii in range(len(vol_list_1)):
    ...
    for y in serialNum:
        ...
        for x in range(nsr):
            ...
            fileName = 'Electrode'+ str(y-10) + 'CV_' + str(int(sr[x]*1000)) + 'mVs' + '_'+ conc_str[iii] # base file name for data file
        ...
        A = 0.000314   # cm2, geometrical area
        C = conc_used[iii]    # mol/cm3, bulk concentration                                  ### (3) CHANGE THIS !!!!

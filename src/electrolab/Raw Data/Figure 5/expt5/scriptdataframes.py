...
parent_path = 'C:/Users/mapence2/Desktop/data/2023_05_24/expt2'
...
mix_to_conc = [0, 1500, 1312.5, 1125, 750, 937.5, 562.5, 375, 187.5]
...
plt.figure()
lim_current = fulldata_IT.loc[(fulldata_IT['Run'] == num_experiments), 'Steady State']*1e9
lim_current = lim_current.values.tolist()
conc_plot = fulldata_IT.loc[(fulldata_IT['Run'] == num_experiments), 'Concentration / mM']
#conc_plot = []
#for x in range(num_folders):
#    conc_plot.append(conc_fxn(1,500,mix_to_conc[x],1500))
plt.plot(conc_plot, lim_current, linestyle = ':', marker='o', markerfacecolor='w', markeredgecolor='k')
plt.xlabel('salt conc / mM',fontdict=fontinfo)
